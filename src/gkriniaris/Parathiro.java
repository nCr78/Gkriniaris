...
public class Parathiro extends javax.swing.JFrame 
{
	...
	pawn_prasino2 = new Pawn(0, 1, "Prasinos2");
        ...
        pawn_prasino4 = new Pawn(0, 3, "Prasinos4");
	...
	pawn_kokino4 = new Pawn(1, 3, "Kokinos4");
	...
	pawn_kitrino4 = new Pawn(3, 3, "Kitrino4");
...
//                    System.out.println("Pawns: "+countPawns);
                ...
                else if(Started_Pawns.contains(p)&&compCount==1)//An to panel pou thelei na paei exei 1 component
                {
                    ...
                    for(int i=0; i<compCount; i++)
                    {
                        ...
                        {
                            star = true;
                            if(Tablo.get(p.getPosition()+diceRolled.getDie1())==(Stars.get(0)))
                            {
                                starNUM = 1;
                                p.setPosition(16);
                            }
                            else if(Tablo.get(p.getPosition()+diceRolled.getDie1())==(Stars.get(1)))
                            {
                                starNUM = 2;
                                p.setPosition(29);
                            }
                            else if(Tablo.get(p.getPosition()+diceRolled.getDie1())==(Stars.get(2)))
                            {
                                starNUM = 3;
                                p.setPosition(42);
                            }
                            else if(Tablo.get(p.getPosition()+diceRolled.getDie1())==(Stars.get(3)))
                            {
                                starNUM = 0;
                                p.setPosition(3);
                            }
...
//                            else if(p.getColor()==3){p.setPosition(p.getPosition()-26);}
	...
	try 
        ...
        catch (IOException | ClassNotFoundException | java.lang.NullPointerException ex) {}
	this.dispose();
	...
	try 
        ...
        {
	    System.out.println("Something went wrong... Game ended!");
	    gameStartedFlag = false;
	    jMenuItem2.setEnabled(false);
	    jMenuItem1.setEnabled(true);
	}
...
//                else if(pawn.getStart() == 0 && pawn_prasino4.getStart()>=0){pawn = pawn_prasino4;}
            int GameL = GameLogic(pawn, SI.getDice(), Prasini_Lista);
            if(GameL==0)
            {
        ...
        {
            int GameL = GameLogic(pawn, SI.getDice(), Kokini_Lista);
            if(GameL==0)
            {
        ...
        {
            int GameL = GameLogic(pawn, SI.getDice(), Ble_Lista);
            if(GameL==0)
            {
        ...
        {
            int GameL = GameLogic(pawn, SI.getDice(), Kitrini_Lista);
            if(GameL==0)
            {
